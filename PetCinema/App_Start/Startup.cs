...
using PetCinemaDAL.Repositories;
using PetCinemaBLL.Interfaces;
using PetCinemaBLL.Services;
using PetCinemaPL.Mappings;
...
namespace PetCinema
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<PetCinemaContext>(options => options.UseSqlServer(sqlConnectionString));
